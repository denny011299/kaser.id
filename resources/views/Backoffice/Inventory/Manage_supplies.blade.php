    ...
    <div class="container-fluid">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Manage Supplies</h4>
            </div>
            <div class="text-end">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-2">
                        ...
                        <select name="" id="input-type" class="form-select">
                            <option value="1">Supplies In</option>
                            <option value="2">Supplies Out</option>
                        </select>
                    </div>
            ...
            <div class="card-body p-4">
                ...
                <div class="tab-content p-3 text-muted">
                    <div class="tab-pane active show" id="navpills-home" role="tabpanel">
                       <table class="table mt-3" id="tableSuppliesAll">
                            <thead>
                                <tr>
                                    <td>SKU</td>
                                    <td>Supplies Name</td>
                    ...
                    <div class="tab-pane  " id="navpills-profile" role="tabpanel">
                       <table class="table mt-3" id="tableSuppliesIn">
                            <thead>
                                <tr>
                                    <td>SKU</td>
                                    <td>Supplies Name</td>
                    ...
                    <div class="tab-pane" id="navpills-messages" role="tabpanel">
                       <table class="table mt-3" id="tableSuppliesOut">
                            <thead>
                                <tr>
                                    <td>SKU</td>
                                    <td>Supplies Name</td>
...
@section('Custom_js')
    <script src="{{asset('custom_js/Inventory/Manage_supplies.js')}}"></script>
@endsection