    ...
    <div class="container-fluid">
          <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Create Purchase Order</h4>
            </div>
            <div class="text-end">
                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <select name="" id="sp_id" class="form-select fill"></select>
                        </div>
                        <div class="col-3">
...
@section('Custom_js')
    ...
    <script src="{{asset('custom_js/Supplier/CreatePurchaseOrder.js')}}"></script>
@endsection